...
$1 -c $2 ../../Weak_Stack_Queue.c ../../ObjectPool.c ../../SinglyLinkedList.c ../../DoublyLinkedList.c
$3 rcs $4.a GeneralLinkedList.o  Weak_Stack_Queue.o ObjectPool.o SinglyLinkedList.o DoublyLinkedList.o ThreadPool.o
   
$1 -c $2 -fPIC ../../ThreadPool/$6.c -o ThreadPool.o
$1 -c $2 -fPIC ../../LinkedList/GeneralLinkedList.c 
$1 -c $2 -fPIC ../../Weak_Stack_Queue.c ../../ObjectPool.c ../../SinglyLinkedList.c ../../DoublyLinkedList.c
$1 $2 -O3 -shared -o $4.$8 GeneralLinkedList.o  Weak_Stack_Queue.o ObjectPool.o SinglyLinkedList.o DoublyLinkedList.o ThreadPool.o $7
