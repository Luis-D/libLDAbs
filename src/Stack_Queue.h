/**
 * @file
 * @brief Collection of MACROS to create Queues and Stacks
 * @details These Queues and Stacks are in fact Singly Linked Lists from SinglyLinkedList.h
 */
...
#define LD_Stack_push		LD_LinkedList_prepend
